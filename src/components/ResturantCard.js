...
const ResturantCard = (props) => {
  ...
  return (
    <div className="mx-3 w-[240px] h-fit rounded-xl  cursor-pointer hover:border-2 hover:border-red-100 hover:shadow-xl hover:border-solid ">
      <div className="p-4 ">
        <img className="rounded-xl " src={CDN_URL} alt="Res Logo" />
      </div>
